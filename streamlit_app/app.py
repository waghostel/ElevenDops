...
def render_main_content() -> None:
    ...
    # Header with branding
    st.title("🏥 ElevenDops Voice Assistant")
    ...
    with st.container(border=True):
        st.markdown(
            ...
            **ElevenDops** is an AI-powered patient education platform that helps physicians 
            ...
            - 📤 **Medical Knowledge Manageemnt** — Create and manage disease-specific educational documents
            - 🔊 **Education Audio Creation** — Generate professional voice recordings using AI
            - 🎙️ **Voice Medical Assistants** — Build custom voice agents to answer patient questions 24/7
            - 📋 **Patient Conversation Insights** — Review conversation logs to understand patient concerns
            """
        )
