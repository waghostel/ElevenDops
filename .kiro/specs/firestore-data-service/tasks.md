...
- [ ] 1. Create DataServiceInterface abstract base class
  - [ ] 1.1 Refactor backend/services/data_service.py
  ...
  - [ ] 1.2 Update MockDataService to implement new interface methods
...
- [ ] 2. Update configuration for data service selection
  - [ ] 2.1 Add use_mock_data setting to backend/config.py
    - Add use_mock_data boolean field with default False
    - Add description explaining when to use mock vs Firestore
    - _Requirements: 2.1, 2.2, 2.3_

  - [ ] 2.2 Update factory function in data_service.py
...
- [ ] 3. Create FirestoreDataService class structure
  - [ ] 3.1 Create backend/services/firestore_data_service.py
  ...
  - [ ] 3.2 Implement helper conversion methods
...
- [ ] 4. Implement Knowledge Document operations
  - [ ] 4.1 Implement create_knowledge_document method
  ...
  - [ ] 4.2 Implement get_knowledge_documents method
  ...
  - [ ] 4.3 Implement get_knowledge_document method
  ...
  - [ ] 4.4 Implement update_knowledge_sync_status method
  ...
  - [ ] 4.5 Implement delete_knowledge_document method
    - Delete document by knowledge_id from KNOWLEDGE_DOCUMENTS
    - Return True on success, False if not found
    - _Requirements: 3.5_

  - [ ] 4.6 Write property test for knowledge document persistence
...
- [ ] 5. Implement Audio File operations
  ...
  - [ ] 5.3 Implement get_audio_file method
    - Get document by audio_id from AUDIO_FILES
    - Return None if not found
    - Convert to AudioMetadata if exists
    - _Requirements: 4.3_

  - [ ] 5.4 Implement delete_audio_file method
    - Delete document by audio_id from AUDIO_FILES
    - Return True on success, False if not found
    - _Requirements: 4.3_

- [ ] 6. Implement Agent operations
  - [ ] 6.1 Implement save_agent method
  ...
  - [ ] 6.2 Implement get_agents method
  ...
  - [ ] 6.3 Implement get_agent method
    - Get document by agent_id from AGENTS
    - Return None if not found
    - Convert to AgentResponse if exists
    - _Requirements: 5.3_

  - [ ] 6.4 Implement delete_agent method
    - Delete document by agent_id from AGENTS
    - Return True on success, False if not found
    - _Requirements: 5.5_

- [ ] 7. Implement Patient Session operations
  - [ ] 7.1 Implement create_patient_session method
  ...
  - [ ] 7.4 Implement get_session_messages method
...
- [ ] 8. Implement Conversation operations
  - [ ] 8.1 Implement save_conversation method
  ...
  - [ ] 8.2 Implement get_conversation_logs method
  ...
  - [ ] 8.3 Implement get_conversation_detail method
    - Get document by conversation_id from CONVERSATIONS
    - Return None if not found
    - Convert to ConversationDetailSchema if exists
    - _Requirements: 6.4_

  - [ ] 8.4 Write property test for conversation query filtering
...
- [ ] 9. Implement Dashboard Statistics
  - [ ] 9.1 Implement get_dashboard_stats method
...
- [ ] 10. Write interface compliance tests
  - [ ] 10.1 Create tests/test_firestore_data_service_props.py
  ...
  - [ ] 10.2 Write factory singleton test
...
- [ ] 11. Write delete operation tests
  - [ ] 11.1 Write property test for delete completeness
...
- [ ] 12. Checkpoint - Verify all CRUD operations work
...
- [ ] 13. Update .env.example with new setting
  - [ ] 13.1 Add USE_MOCK_DATA documentation
