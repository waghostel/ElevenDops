...
This plan implements AI-powered script generation for the Education Audio page using LangGraph and Google Gemini models. Tasks are organized to build incrementally, with backend infrastructure first, then frontend components, and finally integration.

## Tasks

- [x] 1. Set up dependencies and configuration

  - [x] 1.1 Add LangGraph and Google Generative AI dependencies to pyproject.toml

    - Add `langgraph`, `langchain-google-genai` packages
    - Add `GOOGLE_API_KEY` to .env.example
    - _Requirements: 3.1, 4.1_

  - [x] 1.2 Create default prompt configuration file
  ...
  - [x] 1.3 Add Gemini model configuration to backend config
    - Add `GEMINI_MODELS` dictionary with model name mappings
    - Add function to load default prompt from config file
    - _Requirements: 1.1, 5.4_

- [x] 2. Implement backend script generation service

  - [x] 2.1 Create LangGraph workflow for script generation
  ...
  - [x] 2.2 Write property test for Configuration Passthrough

    - **Property 2: Configuration Passthrough**
    - **Validates: Requirements 1.2, 2.4, 3.1, 3.2, 4.3**

  - [x] 2.3 Create script generation service
  ...
  - [x] 2.4 Write property test for Successful Response Format

    - **Property 3: Successful Response Format**
    - **Validates: Requirements 3.3, 4.4**

  - [x] 2.5 Write property test for Error Propagation
    - **Property 4: Error Propagation**
    - **Validates: Requirements 3.4, 4.6**

- [x] 3. Checkpoint - Backend service tests pass

  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Implement backend API endpoint

  - [x] 4.1 Add request/response schemas for script generation

    - Add `ScriptGenerationRequest` and `ScriptGenerationResponse` to `backend/models/schemas.py`
    - _Requirements: 4.1, 4.4_

  - [x] 4.2 Create API endpoint for script generation
  ...
  - [x] 4.3 Write property test for Document Validation
    - **Property 6: Document Validation**
    - **Validates: Requirements 4.2, 4.5**

- [x] 5. Checkpoint - Backend API tests pass

  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Implement frontend components

  - [x] 6.1 Add backend API client method for script generation

    - Add `generate_script_with_ai()` method to `streamlit_app/services/backend_api.py`
    - _Requirements: 4.1_

  - [x] 6.2 Implement LLM model selector dropdown
  ...
  - [x] 6.3 Write property test for Configuration Persistence

    - **Property 1: Configuration Persistence**
    - **Validates: Requirements 1.3, 2.5**

  - [x] 6.4 Implement prompt editor popup
  ...
  - [x] 6.5 Write property test for Prompt Reset Round-Trip

    - **Property 5: Prompt Reset Round-Trip**
    - **Validates: Requirements 2.3**

  - [x] 6.6 Update generate script button to use AI generation
...
- [x] 7. Checkpoint - Frontend integration tests pass

  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Final integration and cleanup

  - [x] 8.1 Add unit tests for UI components
  ...
  - [x] 8.2 Update .env.example with required environment variables
