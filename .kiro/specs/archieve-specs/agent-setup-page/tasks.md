...
- [x] 1. Set up data models and schemas
  ...
  - [x] 1.1 Add agent-related Pydantic schemas to backend/models/schemas.py
  ...
  - [x] 1.2 Write property test for whitespace name validation


    - **Property 1: Whitespace-only names are rejected**
    - **Validates: Requirements 1.3**

  - [x] 1.3 Add AgentConfig dataclass to streamlit_app/services/models.py
...
- [x] 2. Implement ElevenLabs agent service methods

  - [x] 2.1 Add agent creation method to backend/services/elevenlabs_service.py

    - Implement create_agent() using ElevenLabs SDK
    - Handle system prompt and knowledge base configuration

    - _Requirements: 6.2_
  - [x] 2.2 Add agent deletion method to backend/services/elevenlabs_service.py

    - Implement delete_agent() using ElevenLabs SDK

    - _Requirements: 5.2, 6.4_
  - [x] 2.3 Add agent retrieval method to backend/services/elevenlabs_service.py

    - Implement get_agent() for verification
    - _Requirements: 5.1_

- [x] 3. Implement agent service business logic

  - [x] 3.1 Create backend/services/agent_service.py
  ...
  - [x] 3.2 Write property test for answer style to prompt mapping

    - **Property 5: Answer style to prompt mapping**
    - **Validates: Requirements 4.2, 4.3, 4.4**
  - [x] 3.3 Write property test for agent creation returns valid ID
...
- [x] 5. Implement backend API routes
  ...
  - [x] 5.1 Create backend/api/routes/agent.py

    - POST /api/agent - Create new agent
    - GET /api/agent - List all agents
    - DELETE /api/agent/{agent_id} - Delete agent
    - _Requirements: 7.3_
  - [x] 5.2 Register agent routes in backend/main.py

    - Add router to FastAPI app
    - _Requirements: 7.3_
  - [x] 5.3 Write property test for knowledge document association

    - **Property 3: Knowledge document association persistence**
    - **Validates: Requirements 2.2, 2.4**
  - [x] 5.4 Write property test for voice selection persistence
...
- [x] 6. Implement frontend API client methods
  ...
  - [x] 6.1 Add agent methods to streamlit_app/services/backend_api.py
...
- [x] 8. Implement Streamlit Agent Setup page

  - [x] 8.1 Create streamlit_app/pages/4_Agent_Setup.py
  ...
  - [x] 8.2 Write property test for agent deletion
