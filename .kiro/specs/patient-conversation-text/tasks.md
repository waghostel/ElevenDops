...
- [ ] 1. Enhance ElevenLabs Service for Conversational AI
  - [ ] 1.1 Implement real signed URL retrieval from ElevenLabs API
  ...
  - [ ] 1.2 Implement real text message handling with ElevenLabs Conversational AI
  ...
  - [ ] 1.3 Write property test for signed URL format
    - **Property 2: Session creation includes signed_url**
    - **Validates: Requirements 1.2**
  - [ ] 1.4 Write property test for message response format
    - **Property 4: Message response contains text and audio**
    - **Validates: Requirements 2.2, 2.3**

- [ ] 2. Implement Session Management in Patient Service
  - [ ] 2.1 Enhance session creation with Firestore persistence
  ...
  - [ ] 2.2 Enhance message handling with Firestore persistence
  ...
  - [ ] 2.3 Write property test for session creation uniqueness
    - **Property 1: Session creation returns unique session_id**
    - **Validates: Requirements 1.1**
  - [ ] 2.4 Write property test for session data round-trip
    - **Property 3: Session data round-trip to Firestore**
    - **Validates: Requirements 1.3**
  - [ ] 2.5 Write property test for message exchange round-trip
    - **Property 5: Message exchange round-trip to Firestore**
    - **Validates: Requirements 2.4**
  - [ ] 2.6 Write property test for response timestamp
...
- [ ] 4. Implement Conversation Analysis and End Session
  - [ ] 4.1 Implement question categorization logic
  ...
  - [ ] 4.5 Write property test for question categorization
    - **Property 6: Question categorization correctness**
    - **Validates: Requirements 3.1, 4.2**
  - [ ] 4.6 Write property test for requires_attention flag
    - **Property 7: Requires attention flag correctness**
    - **Validates: Requirements 4.1**
  - [ ] 4.7 Write property test for duration calculation
    - **Property 8: Duration calculation correctness**
    - **Validates: Requirements 3.2**
  - [ ] 4.8 Write property test for end session summary
    - **Property 9: End session summary completeness**
    - **Validates: Requirements 3.4**
  - [ ] 4.9 Write property test for conversation log round-trip
...
- [ ] 7. Update Frontend Patient Test Page
  - [ ] 7.1 Update conversation display with audio playback
  ...
  - [ ] 7.2 Improve error handling in frontend
