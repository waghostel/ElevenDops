...
- [ ] 1. Set up project structure and Poetry configuration
  - [ ] 1.1 Create pyproject.toml with Poetry configuration
  ...
  - [ ] 1.2 Create directory structure
    - Create backend/ directory with __init__.py, main.py, api/, models/, services/ subdirectories
...
- [ ] 2. Implement FastAPI backend foundation
  - [ ] 2.1 Create Pydantic models and schemas
  ...
  - [ ] 2.3 Implement mock data service layer
  ...
  - [ ] 2.4 Implement health check endpoint
    ...
    - _Requirements: 2.1_
  - [ ]* 2.5 Write property test for health endpoint
...
- [ ] 6. Implement Streamlit main application (app.py)
  ...
  - [ ] 6.3 Implement sidebar navigation
    - Add navigation section with links to available pages
    - Include appropriate icons for each page link
    - _Requirements: 3.2_
  - [ ] 6.4 Add footer with version info
    - Display version number and copyright notice
    - _Requirements: 3.5_

- [ ] 7. Implement Doctor Dashboard page (1_Doctor_Dashboard.py)
  - [ ] 7.1 Create dashboard page structure
    - Set page title and header
    - Initialize BackendAPIClient
    - _Requirements: 4.1_
  - [ ] 7.2 Implement metric cards display
    ...
    - _Requirements: 4.1_
  - [ ] 7.3 Implement data fetching with error handling
