# Kiro Steering Document Guide

This guide explains how to create and use Kiro steering documents for LLM-assisted development. It's designed for team members using different IDEs or LLM tools who need to understand or replicate this pattern.

## What Are Steering Documents?

Steering documents are markdown files that provide contextual guidance to LLMs during code generation. They act as "always-on" or "conditional" instructions that help the AI understand project conventions, architecture decisions, and coding standards.
...
After front matter, write standard markdown content with:
- Clear headings for organization
- Code examples where helpful
- File references using `#[[file:path/to/file.md]]` syntax
...
## How Steering Documents Are Read
...
Steering documents provide a structured way to give LLMs project-specific context. By following this guide, team members can:

1. Create new steering documents with proper format
2. Choose appropriate inclusion types
3. Reference related documentation
4. Understand how documents are processed
5. Adapt the pattern for other tools
